...
LUA_SHA1 = get_hash(os.path.join(CWD, 'historyhub.lua'))
...
class WgetArgs(object):
    ...
    def realize(self, item):
        wget_args = [
            ...
            '--connect-timeout', '1',
            '--tries', 'inf',
            '--domains', 'historyhub.history.gov',
            '--span-hosts',
            '--waitretry', '30',
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'discussion':
                ...
                if 'HISTORYHUB_COOKIES' in os.environ:
                    cookie = os.environ['HISTORYHUB_COOKIES'].strip()
                    if not cookie.startswith('Cookie: '):
                        cookie = 'Cookie: ' + cookie
                    print('Using header '+cookie)
                    wget_args.extend(['--header', cookie])
...
project = Project(
    ...
    project_html='''
        ...
        <h2>History Hub <span class="links"><a href="https://historyhub.history.gov/">Website</a> &middot; <a href="http://tracker.archiveteam.org/historyhub/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/History_Hub">Wiki</a></span></h2>
        <p>Archiving History Hub.</p>
    '''
)
